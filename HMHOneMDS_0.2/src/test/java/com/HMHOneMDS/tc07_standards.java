...
public class tc07_standards extends genericMethods{
		...
		{  
			...
			else 
			{
				...
				if (online_standard_count>5)
				{
					...
					List<WebElement> standardSections= ListgetWebElements("standSections");
					//for (int i = 0; i < genericMethods.itemsbyxpath.size(); i++ )
					for (int i = 0; i < standardSections.size(); i++ )
